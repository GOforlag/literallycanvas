...
var _require = require('../core/util'),
    classSet = _require.classSet;
...
var CanvasContainer = createReactClass({
  ...
  render: function render() {
    return React.createElement('div', { key: 'literallycanvas', className: 'lc-drawing with-gui', ref: this.props.canvasRef });
  }
});
...
var LiterallyCanvas = createReactClass({
  ...
  bindToModel: function bindToModel() {
    var canvasContainerEl = this.canvasRef;
    var opts = this.props;
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(CanvasContainer, { canvasRef: function canvasRef(el) {
